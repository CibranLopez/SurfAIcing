...
bulk_valid_mac_pot = mac_pot[idx_ref:-idx_ref]
...
vacuum_valid_mac_pot = mac_pot[idx_ref:-idx_ref]
...
plt.plot([mean_avg_pot_vacuum[0, 0], mean_avg_pot_vacuum[-1, 0]], [mean_avg_pot_vacuum, mean_avg_pot_vacuum])
